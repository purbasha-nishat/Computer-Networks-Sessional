...
protected:
   ...
   */
  virtual void ProcessAck (const TcpHeader &tcpHeader, bool scoreboardUpdated,
...
protected:
  ...
  Ptr<TcpTxBuffer> m_txBuffer; //!< Tx buffer (Tcp sender buffer The class keeps track of all data that the application wishes to transmit to the other end.)
