...
main (int argc, char *argv[])
{
    ...
    // outfile2 << 3 + nCsma1 + nCsma2 << " "<<AvgThroughput << " "<<" "<<AvgDelay <<  " "<<((DropPackets*100.00)/SentPackets) << " "<<((ReceivedPackets*100.00)/SentPackets) <<"\n";
    ...
    std::ofstream outfile1;
    outfile1.open(dir + tcpVariant +"-ratio.txt", std::ios_base::app); // append instead of overwrite
    outfile1 <<AvgThroughput << " "<<" "<<((DropPackets*100.00)/SentPackets) <<"\n"; 
